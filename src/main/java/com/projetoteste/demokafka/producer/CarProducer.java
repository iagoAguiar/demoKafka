package com.projetoteste.demokafka.producer;

import com.projetoteste.demokafka.controller.CarDTO;
...
public class CarProducer {
    ...
    private static final Logger logger = (Logger) LoggerFactory.getLogger(CarProducer.class);
    ...
    public void send(CarDTO carDTO){
        kafkaTemplate.send(topic, carDTO).addCallback(
                ...
                failuire -> logger.info("Message failure"+ failuire.getMessage())
        );
    }
}
